...
describe("cleanText", () => {
    ...
    it("preserves important information", () => {
        expect(cleanText("Laptops can be returned within 30 days. SKU: LAP-101.")).toBe("Laptops can be returned within 30 days. SKU: LAP-101.");
    }),
        it("shows cleaning output", () => {
            const input = "   Customers    can return products.\r\n\r\n\r\n\r\n" +
            ...
            // console.log("---------------\n");
            expect(output).toBe("Customers can return products.\n\nReturns are allowed within 30 days.");
        });
});
